...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := sp7731geaopenphone
UBOOT_DEFCONFIG := sp7731geaopenphone
ifeq ($(strip $(BOARD_KERNEL_SEPARATED_DT)),true)
KERNEL_DEFCONFIG := sp7731geaopenphone-dt_defconfig
else
KERNEL_DEFCONFIG := sp7731geaopenphone-native_defconfig
endif
