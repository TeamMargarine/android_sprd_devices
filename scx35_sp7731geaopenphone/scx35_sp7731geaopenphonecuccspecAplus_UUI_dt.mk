...
LOCAL_ORIGINAL_PRODUCT_MAKEFILE := device/sprd/scx35_sp7731geaopenphone/scx35_sp7731geaopenphoneplus_dt.mk

include $(LOCAL_ORIGINAL_PRODUCT_MAKEFILE)
# Rename product name and we can lunch it
PRODUCT_NAME := scx35_sp7731geaopenphonecuccspecAplus_UUI_dt
