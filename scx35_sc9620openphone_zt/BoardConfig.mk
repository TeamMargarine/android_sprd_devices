...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := sc9620openphone_zt
UBOOT_DEFCONFIG := sc9620openphone_zt
KERNEL_DEFCONFIG := sc9620openphone_zt-native_defconfig

TARGET_GPU_DFS_MAX_FREQ := 256000
TARGET_GPU_DFS_MIN_FREQ := 104000
TARGET_GPU_BASE_FREQ := 256
TARGET_GPU_PP_CORE := 4
# SPRD: add nvmerge config
TARGET_RECOVERY_NVMERGE_CONFIG := device/sprd/scx35_sc9620openphone_zt/nvmerge.cfg
...
TARGET_BOARD_CAMERA_NO_720P_PREVIEW := true

#camera exposure metering
TARGET_BOARD_CAMERA_NO_EXPOSURE_METERING := true
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE :=    700000000
ifeq ($(STORAGE_INTERNAL), physical)
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1500000000
else
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1600000000
endif
...
#audio mux
AUDIO_MUX_PIPE := true
AUDIO_CONTROL_PARAMETER_V2 := true
