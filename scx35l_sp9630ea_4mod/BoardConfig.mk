...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := sp9630ea_4mod
UBOOT_DEFCONFIG := sp9630ea_4mod
ifeq ($(strip $(BOARD_KERNEL_SEPARATED_DT)),true)
KERNEL_DEFCONFIG := sp9630ea_4mod_dt_defconfig
else
KERNEL_DEFCONFIG := sp9630ea_4mod_defconfig
endif
