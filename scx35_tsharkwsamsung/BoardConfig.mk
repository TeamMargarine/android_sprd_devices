...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := tsharkwsamsung
UBOOT_DEFCONFIG := tsharkwsamsung
ifeq ($(strip $(BOARD_KERNEL_SEPARATED_DT)),true)
KERNEL_DEFCONFIG := tsharkwsamsung-dt_defconfig
else
KERNEL_DEFCONFIG := tsharkwsamsung-native_defconfig
endif
