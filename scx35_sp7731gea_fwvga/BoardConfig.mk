...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := sp7731gea_fwvga
UBOOT_DEFCONFIG := sp7731gea_fwvga
ifeq ($(strip $(BOARD_KERNEL_SEPARATED_DT)),true)
KERNEL_DEFCONFIG := sp7731gea_fwvga-dt_defconfig
else
KERNEL_DEFCONFIG := sp7731gea_fwvga-native_defconfig
endif
