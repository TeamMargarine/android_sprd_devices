...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := sp7731gea_lc
UBOOT_DEFCONFIG := sp7731gea_lc
ifeq ($(strip $(BOARD_KERNEL_SEPARATED_DT)),true)
KERNEL_DEFCONFIG := sp7731gea_lc-dt_defconfig
else
KERNEL_DEFCONFIG := sp7731gea_lc-native_defconfig
endif
