...
typedef MMEncRet (*FT_MP4EncInit)(MMCodecBuffer *pInterMemBfr, MMCodecBuffer *pExtaMemBfr,MMCodecBuffer *pBitstreamBfr, MMEncVideoInfo *pVideoFormat);
typedef MMEncRet (*FT_MP4EncSetConf)(MMEncConfig *pConf);
typedef MMEncRet (*FT_MP4EncGetConf)(MMEncConfig *pConf);
typedef MMEncRet (*FT_MP4EncStrmEncode) (MMEncIn *pInput, MMEncOut *pOutput);
typedef MMEncRet (*FT_MP4EncGenHeader)(MMEncOut *pOutput);
typedef MMEncRet (*FT_MP4EncRelease)(void);
