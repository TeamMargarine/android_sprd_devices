...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := sp8830gea
UBOOT_DEFCONFIG := sp8830gea
ifeq ($(strip $(BOARD_KERNEL_SEPARATED_DT)),true)
KERNEL_DEFCONFIG := sp8830gea-dt_defconfig
else
KERNEL_DEFCONFIG := sp8830gea-native_defconfig
endif
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 660000000
ifeq ($(STORAGE_INTERNAL), physical)
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1500000000
else
BOARD_USERDATAIMAGE_PARTITION_SIZE := 2930000000
endif
