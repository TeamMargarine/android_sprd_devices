...
static int
memb_gpsTimeAssistanceMeasurementRequest_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_gpsTimeAssistanceMeasurementRequest_constr_4 = {
...
static asn_TYPE_member_t asn_MBR_Rel98_AssistanceData_Extension_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct Rel98_AssistanceData_Extension, gpsTimeAssistanceMeasurementRequest),
		...
		memb_gpsTimeAssistanceMeasurementRequest_constraint_1,
		&asn_PER_memb_gpsTimeAssistanceMeasurementRequest_constr_4,
		0,
...
static asn_TYPE_tag2member_t asn_MAP_Rel98_AssistanceData_Extension_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rel98-Ext-ExpOTD at 730 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* gpsTimeAssistanceMeasurementRequest at 732 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* gpsReferenceTimeUncertainty at 733 */
};
