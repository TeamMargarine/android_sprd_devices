...
static asn_TYPE_member_t asn_MBR_GPSTimeAssistanceMeasurements_1[] = {
	{ ATF_POINTER, 4, offsetof(struct GPSTimeAssistanceMeasurements, referenceFrameMSB),
...
static int asn_MAP_GPSTimeAssistanceMeasurements_oms_1[] = { 0, 1, 2, 3 };
...
static asn_TYPE_tag2member_t asn_MAP_GPSTimeAssistanceMeasurements_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* referenceFrameMSB at 788 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* gpsTowSubms at 789 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* deltaTow at 790 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* gpsReferenceTimeUncertainty at 791 */
};
