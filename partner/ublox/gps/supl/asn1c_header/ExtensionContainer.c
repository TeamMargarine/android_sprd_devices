...
static int asn_MAP_ExtensionContainer_oms_1[] = { 0, 1 };
...
static asn_TYPE_tag2member_t asn_MAP_ExtensionContainer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* privateExtensionList at 28 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* pcs-Extensions at 29 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ExtensionContainer_specs_1 = {
	...
	asn_MAP_ExtensionContainer_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	1,	/* Start extensions */
	3	/* Stop extensions */
};
