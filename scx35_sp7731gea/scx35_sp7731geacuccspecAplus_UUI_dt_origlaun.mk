...
LOCAL_ORIGINAL_PRODUCT_MAKEFILE := device/sprd/scx35_sp7731gea/scx35_sp7731geaplus_dt_origlaun.mk

include $(LOCAL_ORIGINAL_PRODUCT_MAKEFILE)
# Rename product name and we can lunch it
PRODUCT_NAME := scx35_sp7731geacuccspecAplus_UUI_dt_origlaun
