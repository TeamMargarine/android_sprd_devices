...
# call connectivity_configure_8730s.mk before calling device.mk
$(call inherit-product, vendor/sprd/open-source/res/productinfo/connectivity_configure_8730s.mk)
endif
...
# Overrides
PRODUCT_NAME := scx35_sp8730seaplus_dt
