...
# board configs
TARGET_BOOTLOADER_BOARD_NAME := sp9630ea_3592m_3mod
UBOOT_DEFCONFIG := sp9630ea_3592m_3mod
ifeq ($(strip $(BOARD_KERNEL_SEPARATED_ARM_CLK_1350M)),true)
KERNEL_DEFCONFIG := sp9630ea_3592m_3mod_dt_1350M_defconfig
else ifeq ($(strip $(BOARD_KERNEL_SEPARATED_DT)),true)
KERNEL_DEFCONFIG := sp9630ea_3592m_3mod_dt_defconfig
else
KERNEL_DEFCONFIG := sp9630ea_3592m_3mod_defconfig
endif
